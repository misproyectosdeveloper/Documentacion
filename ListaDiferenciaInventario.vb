Public Class ListaDiferenciaInventario
    ...
    Dim SqlB As String
    Dim SqlN As String
    Private Sub ListadoDiferenciaInventario_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    End Sub
    Private Sub ListadoDiferenciaInventario_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated

        Grid.Focus()

    End Sub
    Private Sub ListadoDiferenciaInventario_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Private Sub ButtonAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonAceptar.Click
        ...
        SqlB = "SELECT 1 as Operacion,* FROM DiferenciaCabeza "
        SqlN = "SELECT 2 as Operacion,* FROM DiferenciaCabeza "
    ...
    Private Sub Grid_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Grid.CellDoubleClick
        ...
        UnaDiferenciaInventario.PComprobante = Grid.CurrentRow.Cells("Comprobante").Value
        If Grid.CurrentRow.Cells("Operacion").Value = 1 Then
            UnaDiferenciaInventario.PAbierto = True
        Else : UnaDiferenciaInventario.PAbierto = False
        End If
        UnaDiferenciaInventario.ShowDialog()
