Public Class UnDescarte
    ...
    Dim cb As ComboBox
    Dim ConexionDescarte As String
    Dim DtComprobanteCabeza As DataTable
    Dim DtComprobanteDetalle As DataTable
    Dim DtGrid As DataTable
    Private Sub UnDescarte_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    End Sub
    Private Sub UnDescarte_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub ButtonNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonNuevo.Click
        ...
        PComprobante = 0
        UnDescarte_Load(Nothing, Nothing)
    ...
    Private Sub ButtonAnula_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonAnula.Click
        ...
        If ComboEstado.SelectedValue = 3 Then
            MsgBox("Descarte Ya esta Anulado. Operación se CANCELA.", MsgBoxStyle.Critical + MsgBoxStyle.DefaultButton3)
            Exit Sub
        End If
        ...
        If GGeneraAsiento Then
            If Not HallaAsientosCabeza(6055, PComprobante, DtAsientoCabeza, ConexionDescarte) Then Me.Cursor = System.Windows.Forms.Cursors.Default : Exit Sub
            If DtAsientoCabeza.Rows.Count <> 0 Then DtAsientoCabeza.Rows(0).Item("Estado") = 3
        End If

        If MsgBox("Descarte se Anulara. ¿Desea Anularlo?.", MsgBoxStyle.Question + MsgBoxStyle.YesNo + MsgBoxStyle.DefaultButton3) = MsgBoxResult.No Then
            Me.Cursor = System.Windows.Forms.Cursors.Default
            Exit Sub
        End If
        ...
        Using MiConexion As New OleDb.OleDbConnection(ConexionDescarte)
            ...
            Try
                ...
                '
                Using DaP As New OleDb.OleDbDataAdapter("SELECT * FROM DescarteCabeza;", MiConexion)
                ...
                Else : GModificacionOk = True
                    Trans.Commit()
                    MsgBox("Descarte Anulado Exitosamente.", MsgBoxStyle.Exclamation + MsgBoxStyle.DefaultButton3)
                End If
    ...
    Private Sub ButtonAsientoContable_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonAsientoContable.Click
        ...
        ListaAsientos.PTipoDocumento = 6055
        If PAbierto Then
    ...
    Private Sub PreparaArchivos()
        ...
        If PAbierto Then
            ConexionDescarte = Conexion
        Else : ConexionDescarte = ConexionN
        End If

        DtComprobanteCabeza = New DataTable
        If Not Tablas.Read("SELECT * FROM DescarteCabeza WHERE Clave = " & PComprobante & ";", ConexionDescarte, DtComprobanteCabeza) Then Me.Close() : Exit Sub
        ...
        If Not Tablas.Read("SELECT * FROM DescarteDetalle WHERE Clave = " & PComprobante & ";", ConexionDescarte, DtComprobanteDetalle) Then Me.Close() : Exit Sub
        ...
        For Each Row1 As DataRow In DtComprobanteDetalle.Rows
            ...
            Row("Articulo") = HallaArticulo(Row1("Lote"), Row1("Secuencia"), ConexionDescarte)
            Row("Stock") = HallaStockLote(Row1("Lote"), Row1("Secuencia"), DtComprobanteCabeza.Rows(0).Item("Deposito"), ConexionDescarte)
    ...
    Private Sub HacerAlta()
        ...
        For i As Integer = 1 To 50
            ...
            If DtAsientoCabeza.Rows.Count <> 0 Then
                NumeroAsiento = UltimaNumeracionAsiento(ConexionDescarte)
        ...
        If Resul = -10 Then
            MsgBox("Numero Descarte Ya existe. Operación se CANCELA.", MsgBoxStyle.Critical + MsgBoxStyle.DefaultButton3)
        End If
        If Resul = -1 Then
        ...
        Using MiConexion As New OleDb.OleDbConnection(ConexionDescarte)
            Try
                ...
                Try
                    ...
                    End Using
                    '
                    Using DaP As New OleDb.OleDbDataAdapter("SELECT * FROM DescarteDetalle;", MiConexion)
                        DaP.SelectCommand.Transaction = Trans
                        Dim SqlCommandBuilder As New OleDb.OleDbCommandBuilder(DaP)
    ...
    Private Function ArmaLotes(ByVal Lote As Integer, ByVal Secuencia As Integer, ByVal Cantidad As Decimal, ByRef Dt As DataTable) As Boolean
        ...
        If Not Tablas.Read(Sql, ConexionDescarte, Dt) Then Return False
        ...
        Dt.Rows(0).Item("Descarte") = Dt.Rows(0).Item("Descarte") + Cantidad
    ...
    Private Function ArmaArchivosAsiento(ByVal Funcion As String, ByRef DtAsientoCabeza As DataTable, ByRef DtAsientoDetalle As DataTable) As Boolean
        ...
        If Not Asiento(6055, 0, ListaConceptos, DtAsientoCabeza, DtAsientoDetalle, ListaCuentas, ListaLotesParaAsiento, ListaIVA, ListaRetenciones, DateTime1.Value, 0) Then Return False
    ...
    Private Function UltimaNumeracion(ByVal ConexionStr) As Double
        ...
        Try
            Using Miconexion As New OleDb.OleDbConnection(ConexionStr)
                Miconexion.Open()
                Using Cmd As New OleDb.OleDbCommand("SELECT MAX(Clave) FROM DescarteCabeza;", Miconexion)
