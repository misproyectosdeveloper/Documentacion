Public Class ListaReprocesos
    ...
    Dim SqlB As String
    Dim SqlN As String
    Private Sub ListaReprocesos_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub ButtonAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonAceptar.Click
        ...
        SqlB = "SELECT 1 as Operacion,* FROM ReprocesoCabeza "
        SqlN = "SELECT 2 as Operacion,* FROM ReprocesoCabeza "
    ...
    Private Sub Grid_CellFormatting(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellFormattingEventArgs) Handles Grid.CellFormatting
        ...
        If Grid.Columns(e.ColumnIndex).Name = "Estado" Then
            ...
            If e.Value = "Anulado" Then e.CellStyle.ForeColor = Color.Red
        End If
    ...
    Private Sub Grid_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Grid.CellDoubleClick
        ...
        UnReprocesoLotes.PReproceso = Grid.CurrentRow.Cells("Comprobante").Value
        UnReprocesoLotesNuevo.PReproceso = Grid.CurrentRow.Cells("Comprobante").Value
        If Grid.CurrentRow.Cells("Operacion").Value = 1 Then
            UnReprocesoLotes.PAbierto = True
            UnReprocesoLotesNuevo.PAbierto = True
        Else : UnReprocesoLotes.PAbierto = False
            UnReprocesoLotesNuevo.PAbierto = False
        End If
        If Grid.CurrentRow.Cells("Lote").Value = 0 Then
            UnReprocesoLotesNuevo.ShowDialog()
            UnReprocesoLotesNuevo.Dispose()
        Else
            UnReprocesoLotes.ShowDialog()   ' Anterior cuando se procesaba un lote a la vez.Conservar para compatibilizar con anterior.
            UnReprocesoLotes.Dispose()
        End If
